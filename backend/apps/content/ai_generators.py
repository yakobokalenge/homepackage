...
class AIQuestionGenerator:
    ...
    def convert_pdf_text(self, pdf_text, subject_name, topic_name=None):
        ...
        system_prompt = (
            ...
            "3. Valid question_type values: mcq, true_false, fill_blank, short_answer, essay, matching, ordering.\n"
            "4. Match the question type as closely as possible to the original. If a question is multiple choice, use 'mcq'. If it is open-ended, use 'essay' or 'short_answer'.\n"
            "5. For MCQ / true_false: populate 'options' with the multiple-choice distractors, marking exactly one as is_correct=true.\n"
            "6. Set points to 5.0 for all questions.\n"
            "7. Output explanation if you can deduce the reasoning, otherwise leave it empty.\n"
        )
        ...
        user_prompt = (
            ...
            f"{pdf_text}\n"
            "--- END OF TEXT ---\n\n"
            "Extract all individual questions from this text and return them as a JSON array matching this schema:\n"
            "[\n"
            "  {\n"
            "    \"text\": \"Question text\",\n"
            "    \"question_type\": \"mcq\",\n"
